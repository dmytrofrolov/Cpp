...
BEGIN_EVENT_TABLE(_18_Text_EditorDialog, wxDialog)
    EVT_CLOSE(_18_Text_EditorDialog::OnClose)
    EVT_BUTTON(idBtnQuit, _18_Text_EditorDialog::OnQuit)
    EVT_BUTTON(idBtnAbout, _18_Text_EditorDialog::OnAbout)
END_EVENT_TABLE()

_18_Text_EditorDialog::_18_Text_EditorDialog(wxDialog *dlg, const wxString &title)
...
_18_Text_EditorDialog::~_18_Text_EditorDialog()
{
}

void _18_Text_EditorDialog::OnClose(wxCloseEvent &event)
{
    Destroy();
}

void _18_Text_EditorDialog::OnQuit(wxCommandEvent &event)
{
    Destroy();
}

void _18_Text_EditorDialog::OnAbout(wxCommandEvent &event)
{
